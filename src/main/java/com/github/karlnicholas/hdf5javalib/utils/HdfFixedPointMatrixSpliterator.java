...
import com.github.karlnicholas.hdf5javalib.WeatherData;
...
public class HdfFixedPointMatrixSpliterator<T> implements Spliterator<T> {
    private final FileChannel fileChannel;
    private final long sizeForReadBuffer;
    private final long endOffset;
    private long currentOffset;
    private final FixedPointMatrixSource<T> fixedPointMatrixSource;

    public HdfFixedPointMatrixSpliterator(FileChannel fileChannel, long startOffset, FixedPointMatrixSource<T> fixedPointMatrixSource) {
        this.fileChannel = fileChannel;
        this.sizeForReadBuffer = fixedPointMatrixSource.getSizeForReadBuffer();
        this.currentOffset = startOffset;
        this.endOffset = startOffset + sizeForReadBuffer * fixedPointMatrixSource.getNumberOfReadsAvailable();
        this.fixedPointMatrixSource = fixedPointMatrixSource;
    }
    ...
    public boolean tryAdvance(Consumer<? super T> action) {
        ...
        try {
            ...
            T dataSource = fixedPointMatrixSource.populateFromBuffer(buffer);
