    ...
    public void buildDataObjectHeaderPrefix() {
        ...
        List<CompoundDataType.Member> members = List.of(
                new CompoundDataType.Member("Id", 0, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)8, false, false, false, false, (short)0, (short)64, (short) ("shipmentId".length()+9), new BitSet())),
                ...
                new CompoundDataType.Member("origSort", 15, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)1, false, false, false, false, (short)0, (short)8, (short) ("origSort".length()+9), new BitSet())),
                ...
                new CompoundDataType.Member("destIbi", 23, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)1, false, false, false, false, (short)0, (short)8, (short) ("destIbi".length()+9), new BitSet())),
                ...
                new CompoundDataType.Member("service", 49, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)1, false, false, false, false, (short)0, (short)8, (short) ("service".length()+9), new BitSet())),
                new CompoundDataType.Member("packageType", 50, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)1, false, false, false, false, (short)0, (short)8, (short) ("packageType".length()+9), new BitSet())),
                new CompoundDataType.Member("accessorials", 51, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)1, false, false, false, false, (short)0, (short)8, (short) ("accessorials".length()+9), new BitSet())),
                new CompoundDataType.Member("pieces", 52, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)2, false, false, false, false, (short)0, (short)16, (short) ("pieces".length()+9), new BitSet())),
                new CompoundDataType.Member("weight", 34, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)2, false, false, false, false, (short)0, (short)16, (short) ("weight".length()+9), new BitSet())),
                new CompoundDataType.Member("cube", 36, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)4, false, false, false, false, (short)0, (short)32, (short) ("cube".length()+9), new BitSet())),
                new CompoundDataType.Member("committedTnt", 54, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)1, false, false, false, false, (short)0, (short)8, (short) ("committedTnt".length()+9), new BitSet())),
                new CompoundDataType.Member("committedDate", 55, 0, 0, new int[4],
                        new CompoundDataType.FixedPointMember((short)1, false, false, false, false, (short)0, (short)8, (short) ("committedDate".length()+9), new BitSet()))
        );
