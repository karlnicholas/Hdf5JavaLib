 ...
 */
public abstract class AbstractTypedMatrixStreamingSource<T> {
    ...
    public AbstractTypedMatrixStreamingSource(HdfObjectHeaderPrefixV1 headerPrefixV1, int scale, FileChannel fileChannel, long startOffset) {
