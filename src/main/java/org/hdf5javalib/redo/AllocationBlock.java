...
/**
 * Interface for HDF5 allocation block classes to specify their allocation type.
 * Classes representing storage blocks (e.g., superblock, B-tree nodes, datasets) implement this to indicate their type.
 */
public interface AllocationBlock {
    /**
     * Returns the allocation type of the implementing class.
     * @return The AllocationType enum value.
     */
