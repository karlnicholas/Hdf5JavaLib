 ...
 * @see HdfBTreeV1
 */
public class HdfChunkBTreeEntry {
    ...
    public String toString() {
        return "HdfChunkBTreeEntry{" +
                ...
                "key="+key+", childPointer=\"" + childPointer + "\"" +
        '}';
    }
    ...
    //    /**
//     * Constructs an HdfGroupForGroupBTreeEntry for an internal node, pointing to a child B-Tree.
//     *
//     * @param key              the key for the entry
//     * @param childBTreeAddress the address of the child B-Tree
//     * @param childBTree       the child B-Tree payload
//     */
//    public HdfGroupForGroupBTreeEntry(HdfFixedPoint key, HdfFixedPoint childBTreeAddress, HdfTree childBTree) {
//        this.key = key;
