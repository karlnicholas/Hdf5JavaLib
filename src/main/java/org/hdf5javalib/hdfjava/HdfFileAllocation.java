...
//     */
//    public HdfFixedPoint allocateNextSnodStorage() throws InvocationTargetException, InstantiationException, IllegalAccessException {
...
//     */
//    public HdfFixedPoint allocateAndSetContinuationBlock(String datasetName, HdfFixedPoint continuationSize) throws InvocationTargetException, InstantiationException, IllegalAccessException {
//        Objects.requireNonNull(datasetName, DATASET_NAME_ERROR);
//        Map<AllocationType, AllocationRecord> datasetAllocs = datasetRecordsByName.get(datasetName);
//        if (datasetAllocs == null) {
//            throw new IllegalStateException("Dataset '" + datasetName + "' not found");
...
//     */
//    private void moveDataNextAvailableOffset(HdfFixedPoint newMetadataOffset) throws InvocationTargetException, InstantiationException, IllegalAccessException {
